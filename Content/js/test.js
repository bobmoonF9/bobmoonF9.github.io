...
function use_lang() {					// on change to the language drop down
	...
	if (path.indexOf('/' + lang + '/') == -1) {
		...
		var url = https://documentation.five9.com/de/Content/crm-agents/ADT/softphone/preparing-your-station.htm;
		// var url = https://documentation.five9.com/de/Content/crm-agents/NetSuite/engagement/_ch-processing-digital-engagement-interactions.htm;
